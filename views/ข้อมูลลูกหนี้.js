...
// ฟังก์ชันในการคำนวณจำนวนลูกหนี้ตามประเภทต่างๆ
function getDebtorCounts() {
    // เปลี่ยนเป็นจำนวนที่คำนวณได้จากข้อมูลที่มีจริง
    return {
        inContract: 10, // จำนวนลูกหนี้อยู่ในสัญญา
        withContracts: 5, // จำนวนลูกหนี้ครบกำหนดสัญญา
        exceededContracts: 3, // จำนวนลูกหนี้เลยกำหนดสัญญา
        fullyPaid: 8, // จำนวนลูกหนี้ชำระครบ
        blacklist: 2 // จำนวนลูกหนี้เเบล็คลิช
    };
}
...
var myPieChart2;
function updatePieChart() {
    var debtorCounts = getDebtorCounts();
    ...
    myPieChart2 = new Chart(ctx, {
        type: 'pie',
        data: {
            labels: ['ลูกหนี้อยู่ในสัญญา', 'ลูกหนี้ครบกำหนดสัญญา', 'ลูกหนี้เลยกำหนดสัญญา', 'ลูกหนี้ชำระครบ', 'ลูกหนี้เเบล็คลิช'],
            datasets: [{
                data: [
                    debtorCounts.inContract,
                    debtorCounts.withContracts,
                    debtorCounts.exceededContracts,
                    debtorCounts.fullyPaid,
                    debtorCounts.blacklist
                ],
...
// เรียกใช้ฟังก์ชันในการอัพเดทกราฟเมื่อโหลดหน้า
document.addEventListener("DOMContentLoaded", function() {
    updatePieChart();
});
